...
Beyond the log-transform and standardization, looking at the PCA
...
- As next task suggests - check the distribution of ClusterK4_kmeans within each race,
...
- Nonlinear embeddings: since PC1-3 capture only ~19% of variance, I'm really qurious
  how UMAP or tSNE or maybe autoencoder would separate the samples.